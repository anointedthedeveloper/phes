...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        // Log login attempt
        console.log(`[LOGIN ATTEMPT] Admin login attempt - Username: ${username}, Time: ${new Date().toISOString()}`);
        ...
        try {
            ...
            // Authenticate user
            const user = await db.authenticateUser(username, password, 'admin');
            
            if (user) {
                // Log successful login
                console.log(`[LOGIN SUCCESS] Admin logged in successfully - Username: ${username}, Time: ${new Date().toISOString()}`);
            ...
            // Log error
            console.error(`[LOGIN ERROR] Admin login error - Username: ${username}, Error: ${error.message}, Time: ${new Date().toISOString()}`);
